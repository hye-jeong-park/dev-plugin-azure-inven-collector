...
from plugin.connector.public_ip_addresses.public_ip_addresses_connector import (
    PublicIPAddressesConnector,
)
...
class PublicIPAddressesManager(AzureBaseManager):
    ...
    def create_cloud_service_type(self):
        return make_cloud_service_type(
            ...
            is_major=True,
            labels=["Networking"],
            tags={"spaceone:icon": f"{ICON_URL}/azure-public-ip-address.svg"},
        )
    ...
    def create_cloud_service(self, options, secret_data, schema):
        ...
        public_ip_addresses_list = (
            public_ip_addresses_conn.list_all_public_ip_addresses()
        )
        ...
        for ip_address in public_ip_addresses_list:
            ...
            try:
                ...
                if ip_address_dict.get("ip_configuration") is not None:
                    associated_to = ip_address_dict["ip_configuration"]["id"].split(
                        "/"
                    )[8]
